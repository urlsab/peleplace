...
const faqs = [
  {
    ...
    answer:
      "כל רווק או רווקה מעל גיל 18 שמחפשים מקום חם להיות בו בשבתות וחגים, וכן משפחות, מעסיקים ומתנדבים שרוצים לפתוח את הדלת ולארח.",
  },
  {
  ...
  {
    question: "איך שולחים בקשת הצטרפות?",
    answer:
